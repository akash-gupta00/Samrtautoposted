...
class Settings(BaseSettings):
    ...
    # Ye woh public URL hai jahan se ye app duniya ko dikhta hai.
    # Uploaded media (images/videos) ka absolute link banane ke
    # liye zaroori hai -- Facebook/Instagram/LinkedIn ke servers
    # image ko khud fetch karte hain, isliye localhost URL kaam
    # nahi karega. Live deploy karte waqt .env me isko apne real
    # domain se replace kar dena.
